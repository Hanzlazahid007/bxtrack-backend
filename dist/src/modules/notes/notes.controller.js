...
let NotesController = class NotesController {
    ...
    async create(customerId, dto, user) {
        return this.notesService.create(customerId, dto, user.organizationId, user.sub);
    }
    async findAll(customerId, user) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List notes for a customer' }),
    __param(0, (0, common_1.Param)('customerId', common_1.ParseUUIDPipe)),
...
exports.NotesController = NotesController = __decorate([
    ...
    (0, common_1.Controller)('customers/:customerId/notes'),
